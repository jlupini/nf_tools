var activeComp, assetsFolder, browserImage, browserLayer, footageLayer, selectedLayer, selection, webComp, webCompsFolder;
...
if (selectedLayer.count() === 1) {
  ...
  alert("wrong number of layers selected");
}
